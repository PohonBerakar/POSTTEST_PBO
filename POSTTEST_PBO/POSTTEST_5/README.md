...
# pt5 abstrak
![abstrak](gambar/abs.png)
mengubah kelas parent menjadi abrtrak
![abstrak method](gambar/absmeth.png)
menerapkan abstrak method
![class interface](gambar/classinterface.png)
membuat class ibnterface baru dengan 2 metod yaitu sprole dan rolebonus
![implementasi interface](gambar/impl.png)
implementasi interfcae pada subclass 
![update pada fungsi read](gambar/updlihat.png)
disini kita memperbarui fungsi lihat agar dapat menampilkan sprole dan rolebonus
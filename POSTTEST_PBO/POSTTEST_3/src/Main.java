    ...
    static void lihat(){
        if (daftar.isEmpty()){
            ...
            for(Karakter karakter:daftar){
                ...
                if(karakter instanceof DPS){
                    ((DPS)karakter).infoRole();
                }
                else if(karakter instanceof Tanker){
                    ((Tanker)karakter).infoRole();
                }
                else if(karakter instanceof Healer){
                    ((Healer)karakter).infoRole();
                }
                else if(karakter instanceof Support){
                    ((Support)karakter).infoRole();
                }
